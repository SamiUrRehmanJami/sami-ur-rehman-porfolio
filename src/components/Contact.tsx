    ...
    >
      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12">
          ...
          >
            <div className="bg-card/70 backdrop-blur-glass border border-border rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-glass h-full">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground/70 mt-1">
                      {personal.locationSub}
                    </p>
                  </div>
                </div>
              </div>

              <div className="mt-4 p-6 bg-card/50 backdrop-blur-glass border border-primary/20 rounded-3xl">
                <p className="text-muted-foreground italic text-center">
                  {personal.closingQuote}
                </p>
              </div>
            </div>
          </div>
